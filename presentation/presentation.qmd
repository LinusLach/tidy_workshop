...
```{r}
#| eval: false
https://linus-lach.de/workshops/tidy/presentation
```
...
```{r}
#| echo: false
countdown::countdown(minutes = 7, id = "countdown_lubridate")
```
...
```{r}
#| echo: false
countdown::countdown(minutes = 7, id = "countdown_rf")
```
...
```{r}
#| code-line-numbers: "|3-6|7-8|9|10|11-12|"
library(themis)
...
:::{.fragment index=2}
```{r}
#| code-line-numbers: "|1-6|8-13|15-17|19-22|"
rf_spec <- rand_forest(
  mode = "classification",
  trees = tune(),
  mtry = tune(),
...
```{r}
#| code-line-numbers: "|1-4|6-11|13-14|16-19|20-23|"
tune_spec <- grid_space_filling(
  param_set,
  size = 10
  )
...
:::{.fragment index=2}
```{r}
#| code-line-numbers: "|2|4-7|8-11|12-14|"
...
```{r}
#| code-line-numbers: "|2-9|10|11|12-15|16-17|"
...
:::{.fragment index=2}
```{r}
#| code-line-numbers: "|1-3|5-6|8-10|11-21|13-16|17|18|19|"
library(ggtext)
library(patchwork)
library(glue)
...
```{r}
#| code-line-numbers: "|2-7,14|8,14|9,14|11-13|15-18|"
#| output: false
